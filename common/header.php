...
<html>
	<head>
		<title><?php if(!empty($core->title)){ echo $core->title. ' &nbsp; :: &nbsp;'; }?>Champion Master&nbsp; :: &nbsp;Test your knowledge about the Champions in League of Legends</title>
		...
		<div id="page">
			<header id="header">
				<ul id="navigation">
					...
					<a href="<?php echo $core->conf->http_url; ?>finder"><li>Finder</li></a>
					<a href="https://github.com/DanielBGomez/Champion-Master-Finder" target="_blank"><li>About</li></a>
				</ul>
				<script type="text/javascript">
					$("#menu").click(function(){
