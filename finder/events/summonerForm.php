...
<script>
	$("title").html("Enter your Summoner Name &nbsp;::&nbsp; Finder &nbsp;::&nbsp; Champion Master");
	...
	$("input[type=\'submit\']").click(function(){
		...
		if( $("[name=\'summoner\']").val() != "" && $("[name=\'region\']").val() != "" ){
			window.location = "<?php echo $this->conf->http_url; ?>finder/?case=verifyUser&summoner="+$("[name=\'summoner\']").val()+"&region="+$("[name=\'region\']").val();
		} else {
