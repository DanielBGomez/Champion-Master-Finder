...
class Configuration {
	function __construct(){
		$this->http_url = ($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "192.168.0.7" || $_SERVER['HTTP_HOST'] == "danielbgomez.com") ? "http://".$_SERVER['HTTP_HOST']."/Champion-Master-Finder/" : "http://".$_SERVER['HTTP_HOST']."/";
		$this->disk_url = ($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "192.168.0.7" || $_SERVER['HTTP_HOST'] == "danielbgomez.com") ? $_SERVER['DOCUMENT_ROOT'].'/Champion-Master-Finder/' : $_SERVER['DOCUMENT_ROOT'].'/';
		...
		$this->url_uicon = $this->url_img_version."";
